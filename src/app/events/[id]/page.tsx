...
const events = [
  {
    ...
    requirements: [
      ...
      "GitHub account (we'll help you create one)",
    ],
    registrationUrl:
      "https://fossunited.org/c/university-school-of-automation-and-robotics/git-gudd/rsvp",
    schedule: [
...
• Open-Source Pitch – present contributions like a mini hackathon demo`,
    ...
    schedule: [
      ...
      {
        time: "11:00 AM",
        activity: "Repo Sprint – Build from Base Repos (Creativity Round)",
      },
                  ...
                  <div className="space-y-4">
                    {event.schedule.map((item, index) => (
                      <motion.div
                        ...
                        viewport={{ once: true }}
                      >
                        <div className="text-green-400 font-mono font-semibold min-w-[80px]">
                          {item.time}
                        </div>
                ...
                {event.registrationUrl && event.status === "upcoming" && (
                  <div className="p-6 bg-gradient-to-br from-green-900/20 to-green-800/20 rounded-2xl border border-green-500/30 backdrop-blur-sm">
                    ...
                    <p className="text-gray-300 mb-6">
                      Secure your spot at this amazing event. Limited seats
                      available!
                    </p>
                    <motion.a
